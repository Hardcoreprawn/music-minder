...
use crate::ui::state::{LoadedState, ActivePane};
...
fn viz_mode_button(label: &str, mode: crate::ui::state::VisualizationMode, current: crate::ui::state::VisualizationMode) -> Element<'_, Message> {
...
fn settings_pane(s: &LoadedState) -> Element<'_, Message> {
    use super::library::{organize_section, enrichment_section};
