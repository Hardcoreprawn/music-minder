...
fn parse_wave_formats(formats: u32) -> Vec<u32> {
    ...
    // 11.025 kHz
    if formats & 0x00000001 != 0 || formats & 0x00000002 != 0 || 
       formats & 0x00000004 != 0 || formats & 0x00000008 != 0 {
        rates.push(11025);
    }
    
    // 22.05 kHz
    if formats & 0x00000010 != 0 || formats & 0x00000020 != 0 ||
       formats & 0x00000040 != 0 || formats & 0x00000080 != 0 {
        rates.push(22050);
    }
    
    // 44.1 kHz
    if formats & 0x00000100 != 0 || formats & 0x00000200 != 0 ||
       formats & 0x00000400 != 0 || formats & 0x00000800 != 0 {
        rates.push(44100);
    }
    
    // 48 kHz
    if formats & 0x00001000 != 0 || formats & 0x00002000 != 0 ||
       formats & 0x00004000 != 0 || formats & 0x00008000 != 0 {
        rates.push(48000);
    }
    
    // 96 kHz
    if formats & 0x00010000 != 0 || formats & 0x00020000 != 0 ||
       formats & 0x00040000 != 0 || formats & 0x00080000 != 0 {
        rates.push(96000);
    }
